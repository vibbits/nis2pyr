...
This installs the nis2pyr Python package which provides a simple function to convert ND2 files to OME TIFF. It also install the `nis2pyr` program to convert ND2 files to OME TIFF from the command line.
